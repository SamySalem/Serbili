...
<html>
	...
	<body id="ver-com">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
						...
						echo"<div class='dplay-tbl'>".
                            ...
                            "<a class='p-10 mt-10 btn btn-success livrer' name='".$numero_commande."' href='#'><b>Livraison payée</b></a>".
							"<a class='msg'>cette commande a été livrer et payée !</a>".
                            "</div>".
							"</div>".						
							"</div>".
							"</div>";
        ...
        $sql = "UPDATE Commande SET Etat='payee' WHERE numero_commande=".$_POST['numero_commande'];
        $conn->query($sql);
